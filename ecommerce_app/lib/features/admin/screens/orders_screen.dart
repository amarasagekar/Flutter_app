...
import 'package:ecommerce_app/features/order_deatils/screens/order_details.dart';
...
class _OrdersScreenState extends State<OrdersScreen> {
  List<Order>? orders;
  final AdminServices adminServcies = AdminServices();
  @override
  void initState() {
    super.initState();
    fetchOrders();
  ...
  void fetchOrders() async {
    orders = await adminServcies.fetchAllOrders(context);
    setState(() {});
  }
